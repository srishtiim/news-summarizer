    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-3xl bg-paper-cream clip-torn-paper shadow-modal my-auto"
        >
          {/* Inner Texture */}
          ...
          <div className="relative z-10 p-8 md:p-12 border-[3px] border-ink-dark/10 m-2 md:m-4 clip-torn-paper">
            <button
              onClick={onClose}
              className="absolute top-4 right-4 text-ink-dark hover:text-accent-crimson transition-colors stamp-icon"
              title="Close"
            >
